// схема https://rm-content.s3.amazonaws.com/57024268467568d777fa4a53/623356/upload-1062f260-9175-11e6-9985-1d1ebaecb855.png
...
void loop()
{
  ...
  frequency = map(val, 0, 1023, 2200, 3200);
